import"./modulepreload-polyfill-B5Qt9EMX.js";import{g as s,d as r}from"./content-EQ_ClptF.js";function n(){s("user").then(t=>{const e=document.querySelector(".stats"),o=(t.totalEmissions/400).toString().substring(0,4);e.textContent=`Input tokens: ${t.inputTokens}\r
